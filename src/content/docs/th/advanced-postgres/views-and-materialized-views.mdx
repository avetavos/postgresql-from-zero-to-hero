...
ถ้าตอนนี้คุณ insert หนังสือใหม่ materialized view จะ**ไม่**เปลี่ยน คุณต้องสั่ง `REFRESH` เองเพื่อดึงข้อมูลใหม่:
...
export const quizViews = [
  {
    ...
    options: [
      'คืน row ที่เก็บไว้บนดิสก์จากการ refresh ครั้งล่าสุด',
      'รัน query เบื้องหลังใหม่กับข้อมูลปัจจุบัน',
      'คืนผลลัพธ์ว่างเสมอจนกว่าจะ refresh',
      'แก้ไข table เบื้องหลัง',
    ],
    answer: 1,
  },
  {
    q: 'หลังจาก insert row ใหม่ลงใน table พื้นฐาน materialized view จะเห็น row นั้นเมื่อไหร่?',
    options: [
