...
> 💡 ตัวอย่างจากของจริง
>
> **แพลตฟอร์มที่มีเนื้อหายืดหยุ่นสูง** — เก็บเนื้อหาที่มีโครงสร้างยืดหยุ่นสูง เช่นเนื้อหา page หรือ block ที่เปลี่ยนรูปแบบบ่อย ไว้ใน `jsonb` ส่วนความเป็นเจ้าของ สิทธิ์การเข้าถึง และโครงสร้าง workspace ยังคงอยู่ใน table เชิงสัมพันธ์ที่เคร่งครัด
>
> **แพลตฟอร์ม e-commerce/marketplace** — เก็บ custom field ของสินค้าและ order ที่ผู้ขายแต่ละรายปรับแต่งได้เอง (มักเรียกว่า metafield) ไว้ใน column แบบยืดหยุ่น เพื่อรองรับความหลากหลายของร้านค้าโดยไม่ต้องแก้ schema หลักของ platform

export const quizJsonb = [
  {
    q: 'ข้อได้เปรียบเชิงปฏิบัติที่สำคัญของ jsonb เหนือชนิด json ธรรมดาคืออะไร?',
    options: [
      'รักษา whitespace และลำดับของ key ไว้',
      'ทำ index ได้ และเก็บในรูปแบบไบนารีที่แยกย่อยแล้ว',
      'ยอมให้มี key ซ้ำได้',
      'เป็นชนิดเดียวที่รับ array ได้',
    ],
    answer: 1,
  },
  {
