...
สำหรับหลายแอปพลิเคชัน full-text search ของ PostgreSQL ตัดความจำเป็นในการมี search service แยกต่างหากออกไป คุณได้ stemming, stop word, boolean query และการจัดอันดับใน SQL ธรรมดา โดยทำ index ด้วย GIN หยิบ search engine เฉพาะทางมาใช้ก็ต่อเมื่อคุณโตจนเกินขีดของ PostgreSQL แล้ว ไม่ใช่ใช้เป็นค่าตั้งต้น
</Callout>
...
export const quizFts = [
  {
    ...
    options: [
      'เก็บข้อความไว้ตามตัวอักษรเพื่อจับคู่ substring แบบเป๊ะ ๆ',
      'ทำให้เป็นมาตรฐานเป็น lexeme ตัด stop word ทิ้งและทำ stemming คำ',
      'แปลข้อความเป็นอีกภาษาหนึ่ง',
      'เข้ารหัสข้อความเพื่อเก็บอย่างปลอดภัย',
    ],
    answer: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'เก็บ tsvector ใน generated column แล้วเพิ่ม GIN index ทับ column นั้น',
      'ใช้ LIKE แทน',
