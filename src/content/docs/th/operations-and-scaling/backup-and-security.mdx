...
description: ปกป้องข้อมูลของคุณด้วย backup แบบ logical และ physical และ point-in-time recovery แล้วล็อกการเข้าถึงด้วย role, GRANT และ REVOKE, row-level security, TLS, และ pg_hba.conf
sidebar:
  order: 5
---
...
| ชนิด     | เครื่องมือ                     | เก็บอะไรไว้บ้าง                        | เหมาะที่สุดสำหรับ                  |
|----------|-------------------------------|-----------------------------------------|-----------------------------------|
...
| พึ่งพา replication อย่างเดียวเพื่อความทนทานของข้อมูล | failover เร็ว พร้อมใช้งานสูง | replica ไม่ใช่ backup เพราะคัดลอกทั้งความผิดพลาดและการลบข้อมูลตามไปด้วย |
...
> 💡 ตัวอย่างจากของจริง
>
> **แพลตฟอร์มโซเชียลขนาดใหญ่มาก** — เมื่อระบบต้องรองรับผู้ใช้หลายร้อยล้านคน การซ้อม backup และ recovery อย่างสม่ำเสมอกลายเป็นส่วนหนึ่งของ infrastructure practice มาตรฐาน เพราะ backup ที่ไม่เคยทดสอบคือความเสี่ยงที่ยอมรับไม่ได้
>
...
export const quizBackupSecurity = [
  {
    ...
    options: [
      ...
      'การคัดลอกไฟล์ข้อมูลขณะที่ server ยังรันอยู่ โดยไม่มี WAL',
  ...
  },
  {
    ...
    options: [
      'เข้ารหัสข้อมูลช้าเกินไป',
      'เปิดให้ใครก็ได้เชื่อมต่อในฐานะ role ใดก็ได้โดยไม่ต้องใช้ password',
      'ปิดการทำ backup',
      'ทำงานได้เฉพาะบน Windows เท่านั้น',
    ],
    answer: 1,
  },
];
