...
description: เพิ่ม row ใหม่ หรือ update row เดิมถ้ามีอยู่แล้ว ในคำสั่งเดียว — upsert ของ PostgreSQL ด้วย ON CONFLICT, pseudo-table EXCLUDED และ DO NOTHING
sidebar:
  order: 5
---
