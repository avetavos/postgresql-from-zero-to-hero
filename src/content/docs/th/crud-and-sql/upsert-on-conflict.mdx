...
export const quizUpsert = [
  {
    q: 'column ต้องมีอะไรอยู่ก่อน ON CONFLICT (col) ถึงจะตรวจจับค่าซ้ำได้?',
    options: [
      'foreign key',
      'unique constraint หรือ unique index',
      'NOT NULL constraint',
      'default value',
    ],
    answer: 1,
  ...
  {
    q: 'ใน DO UPDATE ค่า EXCLUDED.copies_sold หมายถึงอะไร?',
    options: [
      'ค่าที่เก็บอยู่ใน row เดิมตอนนี้',
      'ค่าที่เราพยายาม insert เข้าไป',
      'เป็น 0 เสมอ',
      'row สุ่มจาก table',
    ],
    answer: 1,
  ...
  {
    q: 'ON CONFLICT (title) DO NOTHING ทำอะไรเมื่อ title นั้นมีอยู่แล้ว?',
    options: [
      'เกิด unique violation error',
      'อัปเดต row เดิม',
      'ข้ามการ insert โดยไม่กระทบ row ใด ๆ',
      'ลบ row เดิมทิ้ง',
    ],
    answer: 2,
  },
