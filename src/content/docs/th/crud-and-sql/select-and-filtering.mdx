...
> 💡 ตัวอย่างจากของจริง
>
> **API สาธารณะที่ออกแบบมาดี** — บังคับให้ client ระบุ field ที่ต้องการอย่างชัดเจนและมี pagination เสมอ เพื่อป้องกัน `SELECT *` ที่แอบเปลี่ยน contract ของ response และรักษา query plan ให้คาดเดาได้
>
