...
มองทุกการเปลี่ยน schema เป็น migration คือขั้นตอนเล็ก ๆ ที่มีชื่อกำกับ ย้อนกลับได้ และทดสอบได้ก่อนขึ้น production เพิ่ม column พร้อม default หรือ backfill ทีหลัง ทำ constraint ให้เข้มงวดขึ้นหลังข้อมูลสะอาดแล้วเท่านั้น และรันการเปลี่ยนแปลงหลายขั้นตอนใน transaction เดียว migration ที่ระมัดระวังจะไม่มีใครรู้สึก ส่วน migration ที่สะเพร่าคือเหตุระบบล่ม
</Callout>
...
> 💡 ตัวอย่างจากของจริง
>
> **[แนวทาง migration ของ GitLab](https://docs.gitlab.com/development/database/avoiding_downtime_in_migrations/)** — กำหนดให้ deploy โค้ดฝั่งแอปก่อนค่อยเพิ่ม `NOT NULL` constraint และแนะนำให้เพิ่ม column แบบ nullable ก่อนแล้วค่อย backfill แยกต่างหาก เพื่อเลี่ยงการถือ lock นาน ๆ บนฐานข้อมูล production ขนาดใหญ่ระหว่าง deploy
>
> **ทีมที่ดูแลระบบ schema ขนาดใหญ่มาก** — เลือกใช้ pattern แบบ `pg_online_schema_change`-style หรือแบ่ง migration เป็นหลายขั้นตอนเล็ก ๆ โดยเฉพาะกับ table ขนาดใหญ่ เพื่อไม่ให้การเปลี่ยน schema กระทบ traffic การใช้งานจริงระหว่าง deploy
...
export const quizAltering = [
  {
    ...
    options: [
      ...
      'ALTER TABLE จะ lock table ไว้ตลอดไป',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      ...
      'เพิ่ม column แบบ nullable ก่อน, backfill ค่า แล้วค่อยตั้ง NOT NULL',
  ...
  },
  {
    ...
    options: [
      'เพื่อให้รันเร็วขึ้น',
      'เพื่อให้ roll back ได้สะอาดเมื่อล้มเหลว และไม่ทิ้ง schema ไว้ครึ่ง ๆ กลาง ๆ',
